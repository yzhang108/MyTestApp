package com.example.mytestapplication.widge.recyclerview;
 ...
 *
 * 分页展示数据时，RecyclerView的FooterView CalendarState 操作工具类
 *
...
public class RecyclerViewStateUtils {
    ...
    /**
     * 设置headerAndFooterAdapter的FooterView CalendarState
     *
     * @param instance      context
     * @param recyclerView  recyclerView
     * @param pageSize      分页展示时，recyclerView每一页的数量
     * @param state         FooterView CalendarState
