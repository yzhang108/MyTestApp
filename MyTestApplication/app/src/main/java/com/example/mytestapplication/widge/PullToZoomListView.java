...
public class PullToZoomListView extends ListView implements
	...
	public void setmHeaderHeight(int mHeaderHeight) {
		...
		LayoutParams lp =new LayoutParams(DensityUtil.dip2px(mContext, LayoutParams.MATCH_PARENT), mHeaderHeight);
...
//		addHeaderView(this.mHeaderContainer);
		...
		this.mHeaderContainer.setBackgroundColor(paramContext.getResources().getColor(R.color.black));
		this.mHeaderImage.setBackgroundColor(paramContext.getResources().getColor(R.color.colorPrimary));
	}
...
/*	public boolean onInterceptTouchEvent(MotionEvent ev) {
	...
	public void onScroll(AbsListView paramAbsListView, int paramInt1,
		...
		Log.d("mmm", "onScroll");
//		Log.d("mmm", "this.mHeaderHeight="+this.mHeaderHeight);
//		Log.d("mm","this.mHeaderContainer.getBottom()="+this.mHeaderContainer.getBottom());
//		Log.d("mm","this.mHeaderImage.getScrollY()="+this.mHeaderImage.getScrollY());
...
//			Log.d("down","this.mHeaderContainer.getBottom() = "+this.mHeaderContainer.getBottom()+",this.mHeaderHeight="+this.mHeaderHeight);
//			Log.d("down","this.mLastScale="+this.mLastScale);
//			Log.d("down","this.mMaxScale = "+this.mMaxScale);
			break;
		case MotionEvent.ACTION_MOVE:
...
//				Log.d("move","this.mHeaderContainer.getBottom() = "+this.mHeaderContainer.getBottom()+",this.mHeaderHeight="+this.mHeaderHeight);
