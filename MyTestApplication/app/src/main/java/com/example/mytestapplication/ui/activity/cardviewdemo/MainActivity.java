package com.example.mytestapplication.ui.activity.cardviewdemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cardview_demo_main);
        initData();
        initViews();
    }
...
//                        break;
    ...
    private void initData() {
        ...
        mData.add(obj1);
        MessageObj obj2 = new MessageObj("Stark", R.mipmap.ic_0, "7.8K", "钢铁侠是谁？",
                "托尼·斯塔克（小罗伯特·唐尼饰）是“斯塔克工业”的董事长，作为钢铁侠 官方剧照钢铁侠军火商他毁誉不一，但还是过着上流生活。此时，");
        mData.add(obj2);
        MessageObj obj3 = new MessageObj("索尔", R.mipmap.ic_1, "7.8K", "雷神索尔的能力如何？",
                "北欧神话里挥舞着大铁锤、掌控着风暴和闪电的天神，还能用铁锤打开时空之门。暴脾气的他因为自大鲁莽的行为重新点燃了一场古老战争的战火，之后被贬到凡间被迫与人类一起生活。");
        mData.add(obj3);
        MessageObj obj4 = new MessageObj("罗杰斯", R.mipmap.ic_2, "7.8K", "怎么评价美国队长3？",
                "该片根据漫威2006年出版的漫画大事件《内战》改编，背景故事承接于《复仇者联盟2：奥创纪元》事件的余波中，讲述了奥创事件后引发的");
        mData.add(obj4);
        MessageObj obj5 = new MessageObj("黑寡妇", R.mipmap.ic_3, "7.8K", "黑寡妇是一个怎么样的角色？",
